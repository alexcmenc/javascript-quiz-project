document.addEventListener("DOMContentLoaded", () => {
  ...
  //Show the start view (div#startView) and hide the remaining views
  ...
  function showResults() {
    ...
    if (quiz.score > 0) {
      resultContainer.innerText = `You scored ${quiz.score} out of ${quiz.questions.length} correct answers!`; // This value is hardcoded as a placeholder
    } else {
      return (resultContainer.innerText = `There's much to learn young warlock!`);
    }
  }
